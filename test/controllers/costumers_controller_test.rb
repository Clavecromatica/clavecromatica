...
class CostumersControllerTest < ActionController::TestCase
  ...
  test "should create costumer" do
    assert_difference('Costumer.count') do
      post :create, costumer: { apellido_materno: @costumer.apellido_materno, apellido_paterno: @costumer.apellido_paterno, direccion: @costumer.direccion, email: @costumer.email, nombre: @costumer.nombre, password: @costumer.password }
    end
  ...
  test "should update costumer" do
    patch :update, id: @costumer, costumer: { apellido_materno: @costumer.apellido_materno, apellido_paterno: @costumer.apellido_paterno, direccion: @costumer.direccion, email: @costumer.email, nombre: @costumer.nombre, password: @costumer.password }
    assert_redirected_to costumer_path(assigns(:costumer))
  end
