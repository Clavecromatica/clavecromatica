...
class DiscosControllerTest < ActionController::TestCase
  ...
  test "should create disco" do
    assert_difference('Disco.count') do
      post :create, disco: { artista_id: @disco.artista_id, discografica_id: @disco.discografica_id, nombre: @disco.nombre, precio: @disco.precio, publicacion: @disco.publicacion }
    end
  ...
  test "should update disco" do
    patch :update, id: @disco, disco: { artista_id: @disco.artista_id, discografica_id: @disco.discografica_id, nombre: @disco.nombre, precio: @disco.precio, publicacion: @disco.publicacion }
    assert_redirected_to disco_path(assigns(:disco))
  end
