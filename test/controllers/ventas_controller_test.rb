...
class VentasControllerTest < ActionController::TestCase
  ...
  test "should create venta" do
    assert_difference('Venta.count') do
      post :create, venta: { cancion: @venta.cancion, cliente: @venta.cliente, descuento: @venta.descuento, disco: @venta.disco, fecha: @venta.fecha }
    end
  ...
  test "should update venta" do
    patch :update, id: @venta, venta: { cancion: @venta.cancion, cliente: @venta.cliente, descuento: @venta.descuento, disco: @venta.disco, fecha: @venta.fecha }
    assert_redirected_to venta_path(assigns(:venta))
  end
